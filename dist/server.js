...
class IssueEdit extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  constructor() {
    ...
    _defineProperty(this, "notify", () => Object(react_toastify__WEBPACK_IMPORTED_MODULE_11__["toast"])("Cant Modify other Users Posts!"));
  ...
  render() {
    ...
    const user = this.context; //console.log(user,issue);
...
class IssueRowPlain extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  componentDidMount() {
    ...
    const data = Object(_graphQLFetch_js__WEBPACK_IMPORTED_MODULE_4__["default"])(query, null, null);
